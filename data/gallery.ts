export const beforeAfterProjects = [
  {
    ...
    comparisons: [
      {
        ...
        before: {
          image: "/gallery/wire-railing-transformation/before.jpg",
          width: 1125,
          height: 1472,
          alt: "Upstairs landing before the wire railing installation during renovation",
        },
        after: {
          image: "/gallery/wire-railing-transformation/after-main.jpg",
          width: 1125,
          height: 1472,
    ...
    details: [
      {
        image:
          "/gallery/wire-railing-transformation/after-second-view.jpg",
        width: 1125,
        height: 1472,
    ...
    comparisons: [
      {
        ...
        before: {
          image: "/gallery/closet-transformation/angle-1-before.jpg",
          width: 1125,
          height: 1498,
      ...
      },
      {
        ...
        before: {
          image: "/gallery/closet-transformation/angle-2-before.jpg",
          width: 1125,
          height: 1498,
          alt: "Closet before the wire shelf was replaced with custom storage",
        },
        after: {
          image: "/gallery/closet-transformation/angle-2-after.jpg",
          width: 1125,
          height: 1498,
...
export const galleryProjects = [
  ...
  },
  {
    ...
    image: "/gallery/airbnb-stairs-flooring-before-after-v2.jpg",
    width: 1800,
    height: 2200,
  ...
  },
  {
    ...
    image: "/gallery/townhome-pantry-before-after.jpg",
    width: 1003,
    height: 1568,
  ...
  },
  {
    ...
    image: "/gallery/townhome-pantry-organized-before-after.jpg",
    width: 1024,
    height: 1536,
