...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url,
    images: [{
      url: "/gallery/closet-transformation/angle-1-after.jpg",
      width: 1125,
      height: 1498,
...
const articleSchema = {
  ...
  description,
  image: [
    "https://www.truefithome.com/gallery/closet-transformation/angle-1-after.jpg",
    "https://www.truefithome.com/gallery/closet-transformation/angle-2-after.jpg",
  ],
        ...
        <div className="container article-layout">
          <div className="article-body">
            ...
            <figure className="article-comparison">
              <div>
                <Image src="/gallery/closet-transformation/angle-1-before.jpg" alt="Builder-model closet in Tavares before custom shelving was installed" width={1125} height={1498} sizes="(max-width: 760px) calc(50vw - 24px), 380px" />
                <span>Before</span>
              </div>
              <div>
                <Image src="/gallery/closet-transformation/angle-1-after.jpg" alt="Tavares closet after custom shelving, hanging space, vanity, mirror, and lighting were installed" width={1125} height={1498} sizes="(max-width: 760px) calc(50vw - 24px), 380px" />
                <span>After</span>
              </div>
            ...
            <figure className="article-comparison">
              <div>
                <Image src="/gallery/closet-transformation/angle-2-before.jpg" alt="Second view of the Tavares closet before the storage transformation" width={1125} height={1498} sizes="(max-width: 760px) calc(50vw - 24px), 380px" />
                <span>Before</span>
              </div>
              <div>
                <Image src="/gallery/closet-transformation/angle-2-after.jpg" alt="Finished wood shelving and custom hanging area in the Tavares closet" width={1125} height={1498} sizes="(max-width: 760px) calc(50vw - 24px), 380px" />
                <span>After</span>
              </div>
